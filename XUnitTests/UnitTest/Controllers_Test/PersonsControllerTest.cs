...
public class PersonsControllerTest
{
    ...
    public async Task CreatePost_WithModelErrors()
    {
        ...
        var viewResult = result.Subject; 
         ...
         // 'ViewData["AllCountries"]' object
        viewResult.ViewData["AllCountries"].Should().BeAssignableTo<IEnumerable<SelectListItem>>();
        viewResult.ViewData["AllCountries"].Should().BeEquivalentTo(countrySelectListItems);
