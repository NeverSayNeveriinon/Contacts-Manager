    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddControllersWithViews(options =>
            {
                ...
                // "ValidateAntiForgeryTokenAttribute" is for all requests including 'Get' requests
                // "AutoValidateAntiforgeryTokenAttribute" is just for needed requests including 'Post','Put',... requests and not 'Get'
            });
            ...
            // DataBase IOC
            // OR: var DBconnectionString = builder.Configuration["ConnectionStrings:DefaultConnection"];
            ...
            builder.Services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("NotAuthorized", custompolicy =>
                {
                    custompolicy.RequireAssertion(context =>
                    {
                          ...
                          // Or --> return context.User.Identity is null ? false : !context.User.Identity.IsAuthenticated;
                    });
                });
            });
