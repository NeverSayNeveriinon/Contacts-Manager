    ...
    public class PersonResponse
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (Name != objCompare.Name || ID != objCompare.ID || Email != objCompare.Email || DateOfBirth != objCompare.DateOfBirth ||
                ...
                RecieveNewsLetters != objCompare.RecieveNewsLetters || CountryName != objCompare.CountryName || Age != objCompare.Age)
            {
                return false;
            }
        ...
        public override string ToString()
        {
            string message = $"ID:{ID}, Name:{Name}, Email:{Email}, DateOfBirth:{DateOfBirth.ToString()}, Gender: {Gender}" +
                             $", CountryID: {CountryID.ToString()}, Address: {Address}, RecieveNewsLetters: {RecieveNewsLetters}" ;
    ...
    public static class PersonExtensions
    {
        public static PersonResponse ToPersonResponse (this Person person)
        {
            PersonResponse response = new PersonResponse()
            {
                ...
                //Or: Age = Math.Round( (DateTime.Now - person.DateOfBirth!.Value).TotalDays / 365.25 ); 
            };
